...
public:
	...
	friend fstream& operator << (fstream& os, const Businessman& aB);			//Перегрузка записи в файл
	friend fstream& operator >> (fstream& is, Businessman& aBis);				//Перегрузка чтения из файла
};
